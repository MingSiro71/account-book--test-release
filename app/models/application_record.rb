class ApplicationRecord < ActiveRecord::Base
  ...
  def self.dictionary
    array = [
      ...
      {:ja=>"広報費", :en=>"pr_fee"},
      {:ja=>"交際費", :en=>"greetings_expenses"},      
      {:ja=>"接待費", :en=>"entertainment_expenses"},
      {:ja=>"接待交際費", :en=>"greetings_and_entertainment_expenses"},
